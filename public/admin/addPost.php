            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="Addpost.php" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="img[]" id="file-upload" class="file-upload-default"
                        style="display:none;">
                      <!-- Kolom input teks untuk menampilkan nama file yang diunggah -->
                      <div class="input-group col-xs-12">
                        <input type="text" class="form-control file-upload-info" placeholder="Upload Image">
                        <!-- Label sebagai pengganti tombol -->
                        <span class="input-group-append">
                          <label for="file-upload" class="file-upload-browse btn btn-gradient-primary py-3"
                            style="margin: 0;">Upload</label>
                        </span>
                      </div>
                    </div>
